...
> 2026-09-04：V2-P01～P04（消息 / Provider / Agent Loop / 会话持久化）已通过各自范围验收；P05 起进入“对话式 Test Agent + Test Artifact 协作编辑”新路线（[开发主计划](docs/V2/01_DEVELOPMENT_PLAN.md)）。基础测试设计与用例协作编辑现在是 V2 的纵向闭环；固定 case_generation Workflow 退役为 legacy；API 测试、失败根因、造数、缺陷、执行/CI 等更高级能力归 V3。

## 项目入口

- [总项目记录](docs/PROJECT_RECORD.md)
- [V2 开发主计划：V2-P01～P10](docs/V2/01_DEVELOPMENT_PLAN.md)
- [V2 阅读入口与文档职责](docs/V2/README.md)
- [Pi 源码与 Python 映射](docs/V2/references/PI_SOURCE_AUDIT.md)
...
旧隔离用例联调入口只用于历史基线，不作为新 V2 验收。新的分层验证见 [V2 验收清单](docs/V2/03_ACCEPTANCE_CHECKLIST.md) 与 [V2 开发计划](docs/V2/01_DEVELOPMENT_PLAN.md)。
