...
> 更新：2026-09-04。当前生效路线：V2 参考 Pi 用 Python 实现基础 Agent；测试能力统一归 V3。
...
| V2 | Pi 风格 Python Agent 基础：对话、模型流、工具循环、Skill、上下文、持久化、取消、权限 | V2-P01 合同、P02 流式 Provider、P03 纯 Agent Loop 已通过各自范围验收；P04～P10 未实施 |
