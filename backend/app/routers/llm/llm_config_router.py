...
from app.services.llm.llm_client_service import test_llm_model
...
def get_provider(provider_id: int, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
    ...
    from app.services.llm.llm_config_service import _provider_to_response
...
def get_model(model_id: int, db: Session = Depends(get_db), current_user: User = Depends(get_current_user)):
    ...
    from app.services.llm.llm_config_service import _model_to_response
